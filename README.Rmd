...
This branch of the ggseg project uses `ggregions` to create an alternate API for newcomers to brain regions.


First, we make this data simpler (collapse the sub-regions) so that it can work with the ggregions assumptions. 
